...
import { Listener, type AddRuleProps, type ListenerProtocol } from './listener';
    ...
    class Import extends ServiceBase {
      ...
      private validateServiceArn(): string[] {
        ...
        if (!arnPattern.test(this.serviceArn)) {
          errors.push(
            `Service ARN should be in the format 'arn:aws:vpc-lattice:<REGION>:<ACCOUNT>:service/<NAME>', got ${this.serviceArn}.`,
          );
        }
        return errors;
      }
