...
import { AlbTargetGroup, IpTargetGroup, RequestProtocol } from '../../../../src/aws-vpclattice';
...
describe('BaseTargetGroup', () => {
  ...
  test('Invalid protocol for ALB targetType', () => {
    ...
    expect(() => app.synth()).toThrow(
      `Invalid Protocol: ${RequestProtocol.TCP} (must be HTTP or HTTPS if targetType is ALB)`,
    );
  });
