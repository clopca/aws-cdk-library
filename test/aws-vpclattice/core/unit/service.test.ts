...
describe('Service', () => {
  ...
  describe('Service logging destination validation', () => {
    ...
    test('Service with logging destination to S3', () => {
      // GIVEN
      const app = new cdk.App();
      const stack = new cdk.Stack(app, 'TestStack');
  ...
  describe('Import', () => {
    test('Import fromServiceArn', () => {
      ...
      // WHEN
      const service = Service.fromServiceArn(
        stack,
        'ImportedService',
        'arn:aws:vpc-lattice:us-west-2:123456789012:service/svc-12345abcdef',
      );
